...
<p>${inviter} has invited you to join their office: ${office}.
<h2>What does this mean for you?</h2>
<p>You will continue to access to all features that you previously had access to, including all public tables and locations. However, you will now be able to access the "${office}" office.<p>
